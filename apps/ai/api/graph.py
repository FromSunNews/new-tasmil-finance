...
from api import config as lg_api_config
from api.feature_flags import FF_USE_CORE_API, USE_RUNTIME_CONTEXT_API
from api.js.base import BaseRemotePregel, is_js_path
from api.schema import Config
from api.utils.config import run_in_executor, var_child_runnable_config
from api.utils.errors import GraphLoadError
...
async def register_graph(
    ...
    *,
    ...
    from storage.ops import Assistants as AssistantsRuntime

    if FF_USE_CORE_API:
        from api.grpc_ops.ops import Assistants as AssistantsGrpc
        Assistants = AssistantsGrpc
    else:
        Assistants = AssistantsRuntime
    ...
    from storage.retry import retry_db
...
async def get_graph(
    ...
    *,
    ...
    """Return the runnable."""
    from api.utils import config as lg_config
